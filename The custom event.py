...
background_image = pygame.transform.scale( pygame.image.load("mario background.jpg"), (SCREEN_WIDTH, SCREEN_HEIGHT) )
...
sprite5 = Sprite(pygame.Color('blue'), 20, 30)
...
sprite7 = Sprite(pygame.Color('gray'), 20, 30)
